...
openssl req -nodes \
          ...
          -sha256 \
          -batch \
          -subj "/CN=monitor.ah RSA level 2 intermediate"
...
#           -batch \
#           -days 3000 \
#           -subj "/CN=monitor.ah ECDSA level 2 intermediate"
#
# openssl req -nodes \
#           -newkey ec:ecdsa/nistp256.pem \
...
#           -sha256 \
#           -batch \
#           -subj "/CN=monitor.ah EdDSA level 2 intermediate"
#
